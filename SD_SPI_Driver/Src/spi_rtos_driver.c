...
static void __SRD_GPIO_Init (void) {
  ...
  LL_GPIO_SetPinMode(SRD_SPI_CS_GPIO, SRD_SPI_CS_PIN, LL_GPIO_MODE_OUTPUT);
  LL_GPIO_SetPinSpeed(GPIOA, LL_GPIO_PIN_5, LL_GPIO_SPEED_FREQ_HIGH);
  LL_GPIO_SetPinSpeed(GPIOA, LL_GPIO_PIN_6, LL_GPIO_SPEED_FREQ_HIGH);
  LL_GPIO_SetPinSpeed(GPIOA, LL_GPIO_PIN_7, LL_GPIO_SPEED_FREQ_HIGH);
  LL_GPIO_SetPinSpeed(SRD_SPI_CS_GPIO, SRD_SPI_CS_PIN, LL_GPIO_SPEED_FREQ_MEDIUM);
  ...
  LL_GPIO_LockPin(SRD_SPI_CS_GPIO, SRD_SPI_CS_PIN);
}
//-----------------------------------------------------------------------
static bool __SRD_DMA_Init (void) {
  ...
  NVIC_SetPriority(DMA2_Stream5_IRQn, DMAx_STREAMy_FOR_SPI_SD_TX_IRQ_PRIORITY);
  ...
  NVIC_SetPriority(DMA2_Stream0_IRQn, DMAx_STREAMy_FOR_SPI_SD_RX_IRQ_PRIORITY);
